...
<head>
  ...
  <title>Preflight security report</title>
  <style>
...
<body><main class="wrap">
  <header><div><h1>Preflight security report</h1><p class="lede">Deterministic checks for high-confidence security boundaries in AI-written TypeScript.</p></div><span class="status ${statusClass}">${status}</span></header>
  ...
  <p class="footer">Preflight runs locally. Silence is not proof of safety.</p>
</main></body>
</html>
`;
}
